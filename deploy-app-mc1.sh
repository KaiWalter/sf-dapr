...
sed -i "s/<APP VERSION>/$AppVersion/g" $DeploymentFolder/$AppFolder/PackageDapr/ServiceManifest.xml
sed -i "s/<APP NAME>/$AppName/g" $DeploymentFolder/$AppFolder/PackageDapr/ServiceManifest.xml

sed -i "s/<NAMESPACE NAME>/$ServiceBusNamespace/g" $DeploymentFolder/$AppFolder/PackageDapr/CodeDapr/pubsub.yaml
